...
import { roundNum as round } from './src/roundNum';
import { nearestNum as nearest } from './src/nearestNum';

import { ncos } from './src/ncos';
import { nsin } from './src/nsin';

import { linear2db } from './src/linear2db';
import { db2linear } from './src/db2linear';
